...
/**
 * As variantes `qCL`/`aCL` sumiram em 2026-08-10: descreviam o modelo de
 * membresía quando ele era só do Chile, e viraram o texto padrão dos 9
 * mercados. Onde o canal ainda importa, quem decide é `salesCta`.
 */
